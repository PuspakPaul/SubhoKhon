...
const Events = () => {
    ...
    useEffect(() => {
        axiosFetch.get('/events').then(res => setClasses(res.data)).catch(err => console.log(err))
    }, []);
    ...
    return (
        <div>
            <div className="mt-20 pt-3">
                <h1 className="text-4xl font-bold text-center text-secondary dark:text-white">Events</h1>
            </div>
            ...
            <div className="my-16 w-[90%] mx-auto grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                {
                    classes.map((cls, index) => (
                        ...
                        className={`relative hover:-translate-y-2 duration-150 hover:ring-[2px] hover:ring-secondary w-64 
                         mx-auto ${cls.capacity < 1 ? 'bg-red-300' : 'bg-white'} dark:bg-slate-600 
                        ...
                        >
                            <div className="relative h-48">
                                ...
                                <img src={cls.eventImage} alt="" className="object-cover w-full h-full"/>
                                ...
                                >
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        ...
                                        disabled={role === "admin" || cls.capacity <1}
                            ...
                            <div className="px-6 py-2">
                                <h3 className="font-bold mb-1">{cls.eventName}</h3>
                                <p className="text-gray-500 text-x3">Suggested Venue: {cls.suggestedVenue}</p>
                                <div className="flex items-center justify-between mt-4">
                                    <span className="text-gray-600 text-xs">Capacity: {cls.capacity}</span>
                                    <span className="text-green-500 font-semibold">INR {cls.charge}</span>
                                </div>
